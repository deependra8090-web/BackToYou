...
const verifyItemProvider = require("../admin/providers/verifyItem.provider.js");

itemRouter.patch(
  "/items/:id/approved",
  authenticateToken,
  (req, res) => {
    req.body = { ...req.body, action: "approved" };
    return verifyItemProvider(req, res);
  }
);
...
itemRouter.patch(
  ...
  authenticateToken,
  (req, res) => {
    req.body = { ...req.body, action: "rejected" };
    return verifyItemProvider(req, res);
  }
);
